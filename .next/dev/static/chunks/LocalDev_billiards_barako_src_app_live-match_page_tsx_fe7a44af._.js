...
var __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/LocalDev/billiards/barako/node_modules/next/image.js [app-client] (ecmascript)");
...
;
;
const BilliardsBall = ({ number, isMobile = false, isPocketed = false, onClick })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const LiveMatchPage = ()=>{
    ...
    const [player1, setPlayer1] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [player2, setPlayer2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [showPlayer1Modal, setShowPlayer1Modal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showPlayer2Modal, setShowPlayer2Modal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Score state
    const [player1Score, setPlayer1Score] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [player2Score, setPlayer2Score] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [currentTurn, setCurrentTurn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Ball state
    const [pocketedBalls, setPocketedBalls] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    // Double-press R for reset tracking
    const lastResetPress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMatchPage.useEffect": ()=>{
            const fetchPlayers = {
                "LiveMatchPage.useEffect.fetchPlayers": async ()=>{
                    try {
                        ...
                        const playersList = playersSnapshot.docs.map({
                            "LiveMatchPage.useEffect.fetchPlayers.playersList": (doc)=>{
                                const data = doc.data();
                                return {
                                    id: doc.id,
                                    name: data.name || "",
                        ...
                        }["LiveMatchPage.useEffect.fetchPlayers.playersList"]);
                        // Sort by points descending
                        const sortedPlayers = playersList.sort({
                            "LiveMatchPage.useEffect.fetchPlayers.sortedPlayers": (a, b)=>b.points - a.points
                        }["LiveMatchPage.useEffect.fetchPlayers.sortedPlayers"]);
                        setPlayers(sortedPlayers);
                    } catch (error) {
                        console.error("Error fetching players:", error);
                    }
                }
            }["LiveMatchPage.useEffect.fetchPlayers"];
            fetchPlayers();
        }
    }["LiveMatchPage.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMatchPage.useEffect": ()=>{
            const loadMatchData = {
                "LiveMatchPage.useEffect.loadMatchData": async ()=>{
                    try {
                        const matchDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "current_match", "live");
                        const matchDoc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(matchDocRef);
                        if (matchDoc.exists()) {
                            ...
                            if (matchData.player1Id) {
                                if (players.length > 0) {
                                    const p1 = players.find({
                                        "LiveMatchPage.useEffect.loadMatchData.p1": (p)=>p.id === matchData.player1Id
                                    }["LiveMatchPage.useEffect.loadMatchData.p1"]);
                                    if (p1) {
                                        setPlayer1(p1);
                            ...
                            if (matchData.player2Id) {
                                if (players.length > 0) {
                                    const p2 = players.find({
                                        "LiveMatchPage.useEffect.loadMatchData.p2": (p)=>p.id === matchData.player2Id
                                    }["LiveMatchPage.useEffect.loadMatchData.p2"]);
                                    if (p2) {
                                        setPlayer2(p2);
            ...
            }["LiveMatchPage.useEffect.loadMatchData"];
            loadMatchData();
        }
    }["LiveMatchPage.useEffect"], [
        players
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMatchPage.useEffect": ()=>{
            if (players.length > 0 && (player1?.id || player2?.id)) {
                if (player1?.id) {
                    const freshP1 = players.find({
                        "LiveMatchPage.useEffect.freshP1": (p)=>p.id === player1.id
                    }["LiveMatchPage.useEffect.freshP1"]);
                    if (freshP1) {
                ...
                if (player2?.id) {
                    const freshP2 = players.find({
                        "LiveMatchPage.useEffect.freshP2": (p)=>p.id === player2.id
                    }["LiveMatchPage.useEffect.freshP2"]);
                    if (freshP2) {
    ...
    const saveMatchData = async ()=>{
        try {
            const matchDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "current_match", "live");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(matchDocRef, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMatchPage.useEffect": ()=>{
            const handleKeyPress = {
                "LiveMatchPage.useEffect.handleKeyPress": (e)=>{
                    ...
                    if (e.key === "Tab") {
                        e.preventDefault();
                        setCurrentTurn({
                            "LiveMatchPage.useEffect.handleKeyPress": (prev)=>{
                                if (prev === "player1") return "player2";
                                return "player1"; // Handles both "player2" and null
                            }
                        }["LiveMatchPage.useEffect.handleKeyPress"]);
                        return;
                    }
                    ...
                    switch(key){
                        case "q":
                            ...
                            setPlayer1Score({
                                "LiveMatchPage.useEffect.handleKeyPress": (prev)=>prev + 1
                            }["LiveMatchPage.useEffect.handleKeyPress"]);
                            break;
                        case "a":
                            // Decrement Player 1 score (prevent negative)
                            setPlayer1Score({
                                "LiveMatchPage.useEffect.handleKeyPress": (prev)=>Math.max(0, prev - 1)
                            }["LiveMatchPage.useEffect.handleKeyPress"]);
                            break;
                        case "e":
            ...
            return ({
                "LiveMatchPage.useEffect": ()=>window.removeEventListener("keydown", handleKeyPress)
            })["LiveMatchPage.useEffect"];
        }
    }["LiveMatchPage.useEffect"], []);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                title: "Reset all balls",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                    ...
                                    stroke: "currentColor",
                                    strokeWidth: 2,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$LocalDev$2f$billiards$2f$barako$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                        strokeLinecap: "round",
...
_s(LiveMatchPage, "GIhqfXeVgb6xksSztyHRT4pGXWM=", false, function() {
    return [
